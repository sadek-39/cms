        ...
        <div class="mdk-drawer-layout js-mdk-drawer-layout"
            ...
            <div class="mdk-drawer-layout__content page-content">
                ...
                <div class="navbar navbar-expand pr-0 navbar-light border-bottom-2"
                    ...
                    <a href="../Compact_App_Layout/help-center.html"
                ...
                <div class="container page__container page-section">
                    ...
                    <div class="mb-32pt d-flex align-items-center">
                        <small class="text-70 text-headings text-uppercase mr-3">Displaying 10 out of 5,234 articles</small>
                        <div class="dropdown ml-auto">
                            <a href=""
                               data-toggle="dropdown"
                               class="dropdown-toggle text-70">All Topics</a>
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href=""
                    ...
                    <div class="page-separator">
                        <div class="page-separator__text">General</div>
                    </div>
                            ...
                            <div class="card stack stack--1">
                                <div class="card-header d-flex align-items-center">
                                    <div class="flex">
                                        ...
                                        <div class="card-subtitle text-50">Getting started</div>
                                    </div>
                                    <i class="material-icons text-20">info_outline</i>
                                </div>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <a href=""
                                           class="text-body d-flex align-items-center"><strong class="flex">Basic Setup</strong> <i class="material-icons text-20">trending_flat</i></a>
                                    </li>
                                    <li class="list-group-item">
                                        <a href=""
                                           class="text-body d-flex align-items-center"><strong class="flex">Working with the Dev</strong> <i class="material-icons text-20">trending_flat</i></a>
                                    </li>
                                    <li class="list-group-item">
                                        <a href=""
                                           class="text-body d-flex align-items-center"><strong class="flex">Your first deploy</strong> <i class="material-icons text-20">trending_flat</i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="card stack stack--1">
                                <div class="card-header d-flex align-items-center">
                                    <div class="flex">
                                        ...
                                        <div class="card-subtitle text-50">Documentation</div>
                                    </div>
                                    <i class="material-icons text-20">info_outline</i>
                                </div>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <a href=""
                                           class="text-body d-flex align-items-center"><strong class="flex">Styling with SASS</strong> <i class="material-icons text-20">trending_flat</i></a>
                                    </li>
                                    <li class="list-group-item">
                                        <a href=""
                                           class="text-body d-flex align-items-center"><strong class="flex">Editing the Pages</strong> <i class="material-icons text-20">trending_flat</i></a>
                                    </li>
                                    <li class="list-group-item">
                                        <a href=""
                                           class="text-body d-flex align-items-center"><strong class="flex">Saving for later</strong> <i class="material-icons text-20">trending_flat</i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="page-separator">
                        <div class="page-separator__text">Documentation</div>
                    </div>
                    <div class="row mb-32pt">
                        <div class="col-md-6 col-xl-4">
                            <div class="card stack stack--1 mb-0">
                                <div class="card-header d-flex align-items-center">
                                    <div class="flex">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <a href=""
                                           class="text-body d-flex align-items-center"><strong class="flex">Course API Docs</strong> <i class="material-icons text-20">trending_flat</i></a>
                                    </li>
                                    <li class="list-group-item">
                                        <a href=""
                                           class="text-body d-flex align-items-center"><strong class="flex">Student API Docs</strong> <i class="material-icons text-20">trending_flat</i></a>
                                    </li>
                                    <li class="list-group-item">
                                        <a href=""
                                           class="text-body d-flex align-items-center"><strong class="flex">Instructor API Docs</strong> <i class="material-icons text-20">trending_flat</i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
