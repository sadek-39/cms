...
<html>
    ...
    <body>
        <div class="mdk-header-layout__content page-content " >
            <div class="page-section border-bottom-2" id="features_description">
                               ...
                               <div class="card-body d-flex flex-column ">
                                   <div class="d-flex align-items-center">
                                       <div class="flex">
                                           <div class="d-flex align-items-center">
                                               <div class="rounded mr-12pt z-0 o-hidden">
                                                   <div class="overlay">
                                                       <img src="images/paths/Order Document Management.jpg"
                                                            width="40"
                                                            height="40"
                                                            alt="Angular"
                                                            class="rounded">
                                       ...
                                       {{-- <a href="student-path.html"
                                          ...
                                          class="ml-4pt material-icons text-20">favorite_border</a> --}}
                           ...
                           <div class="popoverContainer d-none">
                               <div class="media">
                                   ...
                                   <div class="media-body">
                                       <div class="card-title">Order Document Management</div>
                                       <p class="text-50 d-flex lh-1 mb-0 small">...</p>
                                   </div>
                               </div>
        
                               <p class="mt-16pt text-70"></p>
        
                               <div class="my-32pt">
                                   <div class="d-flex align-items-center mb-8pt justify-content-center">
                                       <div class="d-flex align-items-center mr-8pt">
                                           <span class="material-icons icon-16pt text-50 mr-4pt"></span>
                                           <p class="flex text-50 lh-1 mb-0"><small></small></p>
                                       </div>
                                       <div class="d-flex align-items-center">
                                           <span class="material-icons icon-16pt text-50 mr-4pt"></span>
                                           <p class="flex text-50 lh-1 mb-0"><small></small></p>
                                   ...
                                   <div class="d-flex align-items-center justify-content-center">
                                       <a href="student-path.html"
                                          class="btn btn-primary mr-8pt"></a>
                                       <a href="student-path.html"
                                          class="btn btn-outline-secondary ml-0"></a>
                                   </div>
                               </div>
        
                               <div class="d-flex align-items-center">
                                   <small class="text-50 mr-8pt"></small>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex">
                                        <div class="d-flex align-items-center">
                                            <div class="rounded mr-12pt z-0 o-hidden">
                                                <div class="overlay">
                                                    <img src="images/paths/Supplier Management.jpg"
                                                         width="40"
                                                         height="40"
                                                         alt="Angular"
                                                         class="rounded">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex">
                                        <div class="d-flex align-items-center">
                                            <div class="rounded mr-12pt z-0 o-hidden">
                                                <div class="overlay">
                                                    <img src="images/paths/Production Management.png"
                                                         width="40"
                                                         height="40"
                                                         alt="Angular"
                                                         class="rounded">
                                            ...
                                            <div class="flex">
                                                <div class="card-title">Production Management</div>
                                                <p class="flex text-50 lh-1 mb-0"><small></small></p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex">
                                        <div class="d-flex align-items-center">
                                            <div class="rounded mr-12pt z-0 o-hidden">
                                                <div class="overlay">
                                                    <img src="images/paths/Commercial Management.jpg"
                                                         width="40"
                                                         height="40"
                                                         alt="Angular"
                                                         class="rounded">
                                            ...
                                            <div class="flex">
                                                <div class="card-title">Commercial Management</div>
                                                <p class="flex text-50 lh-1 mb-0"><small></small></p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex">
                                        <div class="d-flex align-items-center">
                                            <div class="rounded mr-12pt z-0 o-hidden">
                                                <div class="overlay">
                                                    <img src="images/paths/Storage Management.jpg"
                                                         width="40"
                                                         height="40"
                                                         alt="Angular"
                                                         class="rounded">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex">
                                        <div class="d-flex align-items-center">
                                            <div class="rounded mr-12pt z-0 o-hidden">
                                                <div class="overlay">
                                                    <img src="images/paths/Payment Management.jpg"
                                                         width="40"
                                                         height="40"
                                                         alt="Angular"
                                                         class="rounded">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex">
                                        <div class="d-flex align-items-center">
                                            <div class="rounded mr-12pt z-0 o-hidden">
                                                <div class="overlay">
                                                    <img src="images/paths/Account Management.png"
                                                         width="40"
                                                         height="40"
                                                         alt="Angular"
                                                         class="rounded">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex">
                                        <div class="d-flex align-items-center">
                                            <div class="rounded mr-12pt z-0 o-hidden">
                                                <div class="overlay">
                                                    <img src="images/paths/Reporting1.png"
                                                         width="40"
                                                         height="40"
                                                         alt="Angular"
                                                         class="rounded">
        ...
        <div class="page-section border-bottom-2" id="module">
            <div class="mdk-box bg-primary mdk-box--bg-primary js-mdk-box mb-0"
                        ...
                        <div class="container-fluid page__container">
                            <div class="d-flex flex-column flex-sm-row">
                                <div class="order-1 order-sm-0">
                                    <h1 class="text-white">Learn How API PDLC can accelerate your Merchandising Activities!!</h1>
                                    <div id="module" class="container">
                                        <p class="collapse text-white" id="collapseExample" aria-expanded="false">
                                        ...
                                        <a role="button" class="collapsed btn btn-dark" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                                        </a>
                                      </div>
                                ...
                                {{-- <div class="ml-sm-auto order-sm-1">
                                    <div class="position-relative overflow-hidden rounded border-4 border-light mb-16pt mb-sm-0">
                                        <div class="bg-primary fullbleed"
                                             style="opacity: .5;"></div>
                                        <img class=""
                                             src=""
                                             alt=""> --}}
        ...
        <div class="page-section border-bottom-2 page__container container">
           <div class="page-separator ">
               <div class="page-separator__text " id="faq">FAQ</div>
           </div>
           <div class="row mb-0 ">
               <div class="col-lg-7">
                   ...
                   <div class="accordion js-accordion accordion--boxed list-group-flush"
                       ...
                       <div class="accordion__item">
                           <a href="{{route('contact')}}"
                              class="accordion__toggle collapsed">
                               <button class="flex btn btn-primary">Need more help?</button>
               ...
               <div class="col-lg-5 justify-content-right price-card">
                   ...
                   <div class="card">
                       <div class="card-body py-16pt text-center">
                           ...
                           <h4 class="card-title"><strong>PDLC</strong></h4>
                           <p class="card-subtitle text-70 mb-24pt">Garments Product Developement Life Cycle</p>
                           <a href="{{route('indexpricing')}}"
                              class="btn btn-accent mb-8pt">Sign Up</a>
           ...
           <div class="page-section">
               <div class="container page__container">
                   <div class="page-headline text-center">
                       <h2>Feedback</h2>
                       <p class="lead measure-lead mx-auto text-70">What other businessman turned professionals have to say about us after learning with us and reaching their goals.</p>
                   </div>
                                       ...
                                       <div class="media-left mr-12pt">
                                           <a href="student-profile.html"
                                              class="avatar avatar-sm">
                                                <img src="images/256_jeremy-banks-798787-unsplash.jpg" width="40" alt="avatar" class="rounded-circle">
                               ...
                               <div class="col-12 col-md-6">
                                   ...
                                   <div class="media ml-12pt">
                                       <div class="media-left mr-12pt">
                                           <a href="student-profile.html"
                                              class="avatar avatar-sm">
                                                <img src="images/256_rsz_1andy-lee-642320-unsplash.jpg" width="40" alt="avatar" class="rounded-circle"> 
                                               <span class="avatar-title rounded-circle">UK</span>
                                           </a>
                                       </div>
                                       <div class="media-body media-middle">
