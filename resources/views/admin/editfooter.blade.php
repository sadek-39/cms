                ...
                <div class="container page__container d-flex flex-column flex-md-row align-items-center text-center text-sm-left">
                    <div class="flex d-flex flex-column flex-sm-row align-items-center mb-24pt mb-md-0">
                        ...
                        <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                          <h2>New Header</h2>
                          <form id="sliderinsertform" action="{{route('footer-update',$data->id)}}" method="POST">
                              @csrf
                                <div class="form-group">
                                  <label for="Menu">Menu Name</label>
                                  <input type="text" name="menu_name" class="form-control" id="menuname" value="{{$data->menu_name}}">
                                </div>
                                <div class="form-group">
                                  <label for="url">url</label>
                                  <input type="text" name="footer_url" class="form-control" id="headerurl" value="{{$data->url}}">
                                </div>
